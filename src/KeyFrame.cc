...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mwMPSBearing(F.mwMPSBearing),mwMPSAngle(F.mwMPSAngle),mwMPSChannel(F.mwMPSChannel),mwMPSTransmitter(F.mwMPSTransmitter),mwMPStime(F.mwMPStime),mwMPSReceiver(F.mwMPSReceiver)
{
    mnId=nNextId++;
